...
segment_folder = os.path.join(os.path.dirname(os.path.abspath(__file__)), './journey_to_the_west/segment')
# 切分之后的句子合集
...
# 保存模型
model2.save(os.path.join(os.path.dirname(os.path.abspath(__file__)), './models/word2Vec.model'))
